# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-08-06 11:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.PositiveIntegerField(default=7, verbose_name='建议学习爱周期(days)')),
                ...
                ('status', models.SmallIntegerField(choices=[(1, '上线'), (2, '下线'), (3, '预上线')], default=0)),
                ('template_id', models.SmallIntegerField(default=2, verbose_name='前端模板')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career_improvement', models.TextField(max_length=1024, verbose_name='课程先修要求')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor_compensation_bonus', models.PositiveIntegerField(unique=15000, verbose_name='本课程的导师辅导费用(贝里)')),
        ...
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='诺是学位课程,此处关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='api.DegreeCourse'),
        ),
        migrations.AddField(
            model_name='course',
            name='sub_category',
