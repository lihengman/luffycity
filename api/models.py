...
class DegreeCourse(models.Model):
    ...
    course_img = models.CharField(max_length=255, verbose_name="略缩图")
    ...
    # 用于 GenericForeignKey反向查询, 不会生成表字段,切勿删除
...
class Scholarship(models.Model):
    ...
    value = models.PositiveSmallIntegerField(verbose_name="奖学金数额")
...
class CourseDetail(models.Model):
    ...
    career_improvement = models.TextField(verbose_name="课程先修要求", max_length=1024)
